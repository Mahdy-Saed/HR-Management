...
//namespace HR_Carrer.Authntication
//{
//    public interface ITokenGenerater<T>
//    {
//        // in genereal all the functions in interface its Public 
//        string CreateAccessToken(T User);

//        string CreateRefreshToken();

//        bool ValidateRefreshToken(T user, string RefreshToken);


//    }

//    public class TokenGenerater : ITokenGenerater<User>  // ioption is also good option rather than Iconfiguraion
