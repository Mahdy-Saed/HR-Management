...
namespace HR_Carrer.Migrations
{
    ...
    [Migration("20250912081342_RefreshTimeExpite")]
    partial class RefreshTimeExpite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Certificate_step", b =>
                {
            ...
            modelBuilder.Entity("Certificate_step", b =>
                {
                    ...
                    b.HasOne("HR_Carrer.Data.Entity.Steps", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HR_Carrer.Data.Entity.User", b =>
                {
                    b.HasOne("HR_Carrer.Data.Entity.Role", "Role")
                        .WithOne("User")
                        .HasForeignKey("HR_Carrer.Data.Entity.User", "RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
